...
contract SnowBank is ISnowBank, Ownable, ReentrancyGuard {
    ...
    /// @notice A % tax is applied to every purchase or sale of tokens.
    uint256 public constant override TAX = 10;
    ...
    /// @notice TempestToken token instance.
    TempestToken public immutable token;
    ...
    constructor(address _vault) public {
      ...
      token = new TempestToken(address(this));
      reserve = _reserve;
